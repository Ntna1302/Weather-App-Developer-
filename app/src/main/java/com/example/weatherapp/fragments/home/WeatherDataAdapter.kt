...
class WeatherDataAdapter (private val onLocationClicked: () -> Unit
    ...
    inner class CurrentLocationViewHolder(private val binding: ItemContainerCurrentLocationBinding) :
